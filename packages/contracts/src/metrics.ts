...
export const DEFAULT_METRIC_CATALOG: MetricCatalog = [
  ...
  {
    id: "benchmark_rs_3m",
    label: "Benchmark RS 3months",
    aliases: ["Benchmark RS 3months", "Relative Strength vs Benchmark 3months"],
    column: "benchmark_rs_3m",
    valueType: "number",
    unit: "percent",
    assetClasses: allClasses,
  },
  {
    id: "benchmark_rs_6m",
    label: "Benchmark RS 6months",
    aliases: ["Benchmark RS 6months", "Relative Strength vs Benchmark 6months"],
    column: "benchmark_rs_6m",
    valueType: "number",
    unit: "percent",
    assetClasses: allClasses,
  },
  {
    id: "benchmark_rs_12m",
    label: "Benchmark RS 12months",
    aliases: ["Benchmark RS 12months", "Relative Strength vs Benchmark 12months"],
    column: "benchmark_rs_12m",
    valueType: "number",
    unit: "percent",
    assetClasses: allClasses,
  },
