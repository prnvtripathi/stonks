...
export const DEFAULT_GLOSSARY_ENTRIES: readonly GlossaryEntry[] = [
  ...
  { slug: "volatility", term: "Volatility", aliases: ["Annualized volatility", "Price volatility"], summary: "A measure of how widely observations vary around their average, annualized for comparison.", formula: { expression: "standard deviation of periodic returns × √periods per year", provenance: [SOURCE.niftyIndicators] }, interpretation: "Higher volatility means a wider historical range of outcomes, not an automatic sign of loss or opportunity.", pitfalls: ["The lookback and sampling frequency matter.", "Historical volatility is backward-looking and can change quickly."], assetClasses: ALL, sources: [SOURCE.niftyIndicators], reviewedAt: REVIEWED_AT },
  { slug: "drawdown", term: "Drawdown", aliases: ["Maximum drawdown", "Peak-to-trough decline"], summary: "The decline from a prior running peak to a later observation in a price or NAV series.", formula: { expression: "(current value ÷ prior running peak − 1) × 100", provenance: [{ label: "Stonks methodology", url: "/learn/drawdown" }] }, interpretation: "Maximum drawdown summarizes the deepest peak-to-trough fall in the selected history.", pitfalls: ["The recovery period is not captured by the percentage alone.", "A short history can understate long-run downside."], assetClasses: ALL, sources: [SOURCE.nseTechnical], reviewedAt: REVIEWED_AT },
